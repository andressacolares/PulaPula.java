...
public class Runner {
    public static void main(String[] args) {
        ...
        */
        ...
        pulaPula.entrarNaFila(new Criança("mario", 5));
        pulaPula.entrarNaFila(new Criança("ana", 4));
        pulaPula.entrarNaFila(new Criança("diego", 3));
        System.out.println(pulaPula);
        /*
            Caixa: R$ 0.0 Limite: 0/5
        ...
        */
        ...
        //Fechar o pula-pula  
        pulaPula.entrarNaFila(new Criança("luiza", 8));
        pulaPula.sair();
        pulaPula.entrar();
        System.out.println(pulaPula);
        /*
